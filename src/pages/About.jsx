  ...
  return (
    <section className="relative py-10 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mission Section */}
        <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8 mb-10 transform hover:scale-[1.02] transition-all duration-300">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          {[
            ...
            >
              <div className="text-3xl font-bold text-red-500 mb-1">{stat.number}</div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden">
              <div className="aspect-square bg-gradient-to-br from-red-100 to-orange-100 flex items-center justify-center">
                <img
                  src="https://i.pinimg.com/736x/82/13/fc/8213fc81ce70ff76253ab4c3d4b04488.jpg"
                  alt="Chef Nith"
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
              ...
              authentic Italian pizzas. His journey began in Naples, where he
              mastered traditional pizza-making under renowned Italian chefs.
            </p>
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              His secret sauce, passed down through generations, and his exceptional
              dough-making skills make Pizza House truly unique.
            </p>
        ...
        {/* Promise Section */}
        <div className="mt-12 text-center bg-white rounded-3xl shadow-2xl p-10 border border-red-100">
          <h3 className="text-3xl font-bold text-gray-900 mb-4">Our Promise to You</h3>
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            We promise to deliver not just pizza, but an authentic Italian experience in every bite.
            We commit to using the finest ingredients, traditional methods, and heartfelt passion.
          </p>
        </div>
      </div>
    </section>
